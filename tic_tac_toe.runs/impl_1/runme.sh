...
HD_PWD='C:/Users/Taha/tic_tac_toe/tic_tac_toe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tic_tac_toe_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tic_tac_toe_game.tcl -notrace
